...
Avoid prompting without skills, agents and prompt files. Even for simple tasks like properties update in endpoint, you should have a clear definition for the AI Agent on what steps shoudl be performed.
