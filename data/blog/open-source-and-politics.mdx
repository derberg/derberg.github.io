...
I planned to write this article in February. Then Putin, a little piece of shit, decided to attack Ukraine, and things got a bit more complicated. After all, the delay in writing the article was not that bad. The war brought some mess into open source too.
...
This is just one of many stories like this in open source. Just look at [history of AppGet getting killed by Microsoft](https://keivan.io/the-day-appget-died/).
...
I do know many people say: `you should have used package-lock.json, and you would not be affected`. No, he should just not do it, so I'm not affected. Even if my code on production did not break, I still need to waste my time removing this dependency from my code. I just don't want that there, period.
...
Like OMG! You do not expect these things in open source. Like seriously...
...
Easier was to take a piss on open source.

## Was it worth it?

Open source is not just about USA - why would I even care about Aaron Swartz? I don't.
Open source is not about Ukraine or Russia - why would contributors from India or somewhere in South America even care. I care, but I'm biased, I live in Poland, and we are too close to the conflict to ignore it. I cared about Afghanistan, but I was biased, I just knew one open-source contributor that lived there and was affected.

Are people really that naive, thinking that such behavior can do anything good to the world?

Just get over it and realize open source is not your little local bubble, not your small office space. The faster you realize it, the better. You must see that with global reach, patience, and being part of the community, you can actually achieve many good things.
...
What will happen is that enterprises will invest more in security and tools to detect these issues. People will not all suddenly learn to lock their dependencies.

There will be tools like [Chainalert](https://checkmarx.com/blog/protestware-politics-and-open-source-software/) or others that monitor open-source and early detect your wicked `protestware`.
